            ...
            >
                <View style={[Layout.colVCenter, { paddingBottom: 40, width: '100%', backgroundColor: Colors.primary, position: 'absolute', bottom: 0, elevation: 5, borderTopLeftRadius: 40, borderTopRightRadius: 40, padding: 20 }]}>
                    ...
                    <View style={[Layout.rowHCenter, { marginTop: 20 }]}>
                        <TouchableOpacity
                            onPress={() => {console.log("click"); offset.value =withSpring(1) }}
                            onPressIn={()=>{offset.value = withSpring(1.2)}}
                            // onPressOut={offset.value = withSpring(0.9)} 
                        >
                            <Animated.View style={[Layout.rowHCenter, { height: 40, marginHorizontal: 5, backgroundColor: Colors.white, paddingVertical: 5, paddingHorizontal: 5, borderRadius: 20, }, { ...animatedStyles }]}>
                                ...
                                <Text style={[Fonts.h5, { color: Colors.primary, marginHorizontal: 4 }]}>
                                    Breakfast
                                </Text>
                            </Animated.View>
                        </TouchableOpacity>
                        <TouchableOpacity style={[Layout.rowHCenter, { height: 40, marginHorizontal: 5, backgroundColor: Colors.white, paddingVertical: 5, paddingHorizontal: 5, borderRadius: 20 }]}>
                            <View style={[Layout.rowCenter, { width: 30, height: 30, backgroundColor: Colors.primary, borderRadius: 20, marginHorizontal: 5 }]}>
                                <Icon name='checkmark-outline' size={22} color={Colors.white}></Icon>
                            </View>
                            <Text style={[Fonts.h5, { color: Colors.primary, marginHorizontal: 4 }]}>
                                Dinner
                        ...
                        <TouchableOpacity style={[Layout.rowHCenter, { opacity: 0.7, height: 40, marginHorizontal: 5, backgroundColor: Colors.white, paddingVertical: 5, paddingHorizontal: 5, borderRadius: 20 }]}>
                            <Text style={[Fonts.h5, { color: Colors.text, marginHorizontal: 8 }]}>
                                lunch
                            </Text>
                        </TouchableOpacity>
                    </View>
